...
Add one with `python3 ../amigapkg.py add …` (computes the archive SHA-256), or copy
an existing entry and follow the schema. Then
`python3 ../amigapkg.py validate packages/foo.json --check-archives` before opening
a PR. See `../CONTRIBUTING.md`.
